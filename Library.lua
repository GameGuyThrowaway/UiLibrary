...
function Library:UpdateColorsUsingRegistry(notFont)
    ...
    for Idx, Object in next, Library.Registry do
        for Property, ColorIdx in next, Object.Properties do
            if type(ColorIdx) == 'string' then
                if ColorIdx ~= "FontColor" or not notFont then
...
function Library:CreateWindow(WindowTitle, AutoShow, Size)
    local Window = {
        Tabs = {};
    };
    ...
    local Outer = Library:Create('Frame', {
        ...
        Size = Size or UDim2.new(0, 550, 0, 600);
        Visible = false;
        ZIndex = 1;
        Parent = ScreenGui;
    });
